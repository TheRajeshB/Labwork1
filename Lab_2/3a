...
plt.errorbar(r,simp(V,-pi/2,pi/2,9),label='Simpson integration result for N=')
...
diff = eqn_9 -simp(V,-pi/2,pi/2,8) 
plt.plot(r,diff,label='Difference for N =')
